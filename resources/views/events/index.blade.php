            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8 transform transition-all duration-300 hover:shadow-md">
                <form action="{{ route('events.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Event title or location..." class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 sm:text-sm transition duration-150">
                    </div>
                    <div>
                        <label for="category" class="block text-sm font-medium text-gray-700 mb-1">Category</label>
                        <select name="category" id="category" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 sm:text-sm transition duration-150">
                    ...
                    <div>
                        ...
                        <input type="date" name="date" id="date" value="{{ request('date') }}" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 sm:text-sm transition duration-150">
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                        ...
                        <div class="p-6">
                            <div class="flex items-center text-sm text-gray-500 mb-4 space-x-4">
                                ...
                                <div class="flex items-center">
                                    <svg class="w-4 h-4 mr-1.5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center p-12 bg-white rounded-3xl border border-dashed border-gray-300">
                        ...
                        <a href="{{ route('events.index') }}" class="mt-4 text-gray-900 hover:text-black font-medium text-sm">Clear filters</a>
                    </div>
                @endforelse
            </div>
