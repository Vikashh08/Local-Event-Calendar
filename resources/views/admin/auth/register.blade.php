<x-guest-layout>
    <div class="mb-10 text-center lg:text-left">
        ...
        <p class="text-gray-500 mt-2">Create an administrator account to manage the platform.</p>
    </div>
    ...
    <div class="mt-10 text-center lg:text-left">
        <p class="text-gray-500">Already registered? 
            <a href="{{ route('admin.login') }}" class="font-bold text-gray-900 hover:underline">Log in</a>
        </p>
    </div>
</x-guest-layout>
